Write a Java program to Find size of the largest â€˜+â€™ formed by all ones in a binary matrix 


Given a N X N binary matrix, find the size of the largest â€˜+â€™ formed by all 1s.
...
For above matrix, largest â€˜+â€™ would be formed by highlighted part of size 8.

The idea is to maintain four auxiliary matrices left[][], right[][], top[][], bottom[][] to store consecutive 1â€™s in every direction. For each cell (i, j) in the input matrix, we store below information in these four matrices â€“
